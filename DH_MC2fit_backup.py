...
class MC2fitRun():
     ...
     * add_params_mode : bool or array (default: True)
    ...
    def _each_run(self, thisrunlist):
        ...
        for comp in range (thisrunlist['ncomp']):
            if(comp<(self.Ncomp_add_params_array)):
                ...
                if(self.add_params_mode[comp]==True): thisrunlist['est_params'][comp]+=self.add_params_array[comp]
